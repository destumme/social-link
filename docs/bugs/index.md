...
|----|-------|----------|--------|
| [BUG-010](BUG-010-own-profile-missing-traits.md) | Own profile page returns 404 or hides private traits | high | open |

## Resolved

| ID | Title | Severity | Resolved |
|----|-------|----------|----------|
| [BUG-009](BUG-009-user-not-found-after-settings-update.md) | User not found after changing display name and username in settings | high | 2026-07-12 |
| [BUG-008](BUG-008-traits-not-visible-on-profile.md) | Traits not visible to connected users on profile page | high | 2026-07-12 |
